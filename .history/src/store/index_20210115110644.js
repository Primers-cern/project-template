  ...
  actions: {
    ...
    authorization({
      ...
      return new Promise((resolve, reject) => {
        let
          url = 'Index/RolePower/getRolePowersByFront',
          params = {
    ...
    getUserInfo({
      ...
      return new Promise((resolve, reject) => {
        ...
        let
          url = 'Index/UserBase/getBaseInfoByUser',
          params = {
            id
          }
    ...
    getProjectInfo({ commit, state }, reload) {
      return new Promise(resolve => {
        ...
        let url = 'Index/Index/getProjectInfo'
        vue.$http(url)
          .then(data => {
            let res = data.data,
            ...
            if (!info.title) {
              info.title = "创新创业CMS"
              info.version_admin = 'v1.00'
              info.version_mobile = 'v1.00'
            }
